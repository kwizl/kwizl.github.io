...
| --------------------------- | ------------------- | ----------------------------------------------------------------------------|
| **Interchange Fee**         | **Issuer**          | The largest portion of the fee. Set by the schemes but paid to the customer |
...
|                             |                     | infrastructure.                                                             |
|                             |                     |                                                                             |
| **Acquirer Markup**         | **Acquirer / PSP**  | The fee charged by the acquiring bank for providing the processing services,|
|                             |                     | hardware, and handling risks.                                               |

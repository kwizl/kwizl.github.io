...
0 2 1 0   0 0 0 2   1
└───┬───┘ └───┬───┘  ▬
    │         │      └── Check Digit (9th digit)
    │         └── Institution Identifier (Digits 5-8)
...
S B I N  0  0 0 4 3 2 1
└───┬───┘ ▬ └─────┬─────┘
    │     │       └── Branch Code (Last 6 characters)
    │     └── Control Character (Always zero)
    └── Bank Code (First 4 alphabetic characters)
...
620  -  0 4  -  0 4
   └─┬─┘   └───┬────┘
     │         └── Branch Identifier (Last 4 digits)
     └── Bank/Settlement Code (First 2 digits)
